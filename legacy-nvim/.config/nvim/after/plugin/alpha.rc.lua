...
local default_header = {
  ...
  val = {
    ...
    [[  \/_/    \/_____/ \/_____/ \/_/ \/_/   \/_/  \/_/\/_/ \/_____/   \/_/  \/_/ \/_____/ ]],
    [[ ]],
    [[ - Miguel Fuentes - Fuentastic - 2024 - ]],
  },
  opts = {
    hl = "Type",
    shrink_margin = false,
...
local get_layout = function()
  return query.alpha_workspace_layout(workspaces, button, {
...
local function file_button(fn, sc, short_fn, autocd)
  ...
  if fn_start ~= nil then
    table.insert(fb_hl, { "Comment", #ico_txt - 1, #fn_start + #ico_txt - 1 })
  end
...
local function mru_title()
  return "Recent files: " .. vim.fn.getcwd()
end
